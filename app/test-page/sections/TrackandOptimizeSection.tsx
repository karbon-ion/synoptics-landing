  ...
  const TrackSection = () => {
    return (
      <div className="w-full relative overflow-hidden min-h-[500px] md:min-h-[600px]" 
        ...
        <div className="w-full max-w-7xl mx-auto sm:px-6 py-12 md:py-16 flex flex-col md:flex-row items-center gap-8 md:gap-16 lg:gap-24">
          ...
          <div className="w-full   flex justify-center items-start">
            <div className="relative w-full max-w-4xl w-[450px] h-[450px]">
              <Image
