    ...
    >
      <div className="w-full max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          {/* Main Banner */}
          <div
            className="md:col-span-2 rounded-xl p-8 flex flex-col justify-center relative overflow-hidden border-8 border-white h-[276px]"
            style={{
          ...
          >
            ...
            <div className="mt-6">
              <Link
                href="#"
                className="inline-flex items-center justify-center gap-2 bg-[#5662F6] text-white px-6 py-3 rounded-full text-sm font-bold transition-all duration-300 hover:shadow-md"
                style={{
                  fontSize: "18px",
                  lineHeight: "100%",
                  letterSpacing: "0px",
