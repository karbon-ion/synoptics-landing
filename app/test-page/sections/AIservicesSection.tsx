        ...
        <div className="w-full py-16" style={{
            ...
            <div className="w-full max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 justify-center">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm transition-all duration-300 hover:shadow-md" style={{ width: '384px', height: '250px' }}>
                        <div className="mb-4">
                        ...
                        <Link
                            href="#"
                            className="inline-flex items-center gap-1 text-indigo-500 mt-4"
                            style={{
                                fontFamily: 'Syne, sans-serif',
                                fontWeight: 700,
                                fontSize: '14px',
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center">
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm transition-all duration-300 hover:shadow-md" style={{ width: '384px', height: '250px' }}>
                        <div className="mb-4">
                            <div className="bg-[#5662F6] p-2 rounded-full w-10 h-10 flex items-center justify-center">
                        ...
                        <Link href="#" className="inline-flex items-center gap-1 text-indigo-500 mt-4"
                        style={{
                            fontFamily: 'Syne, sans-serif',
                            fontWeight: 700,
                            fontSize: '14px',
