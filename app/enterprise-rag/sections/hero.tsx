export default function RagHero() {
    return (
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 py-16 bg-gradient-to-b bg-[#f0f5ff]">
            ...
            See what your AI is doing—how it performs, where it excels, and where it needs to improve. 
            With real-time metrics on accuracy, efficiency, and user sentiment, Synoptix puts you in control.  
            </p>
