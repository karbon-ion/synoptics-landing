...
export default function EnterpriseSection() {
  ...
  const tabData: {
  ...
  }[] = [
    {
      ...
      description: "Find real-time, accurate answers across documents, emails, policies, and systems—instantly and securely.",
      iconWidth: "42px",
      iconHeight: "36px",
      showLearnMore: true,
    },
    {
      ...
      description: "Build custom agents that understand your data, automate workflows, and support real-time decision-making.",
      iconWidth: "45px",
      iconHeight: "45px",
      showLearnMore: true,
    },
    {
      ...
      description: "Pre-built AI agents and prompts to accelerate adoption—easily customize, deploy, and share across teams to boost productivity.",
      iconWidth: "27px",
      iconHeight: "22px",
      showLearnMore: true,
    },
