  ...
  const techniqueData = [
    {
      ...
      image: "/images/New/AI Readiness Assessment.png",
      benefits: [
    ...
    },
    {
      ...
      image: "/images/New/AI Envisioning Workshop.png",
      benefits: [
    ...
    },
    {
      ...
      description: "Deploy AI solutions tailored to your unique business needs—optimising workflows, enhancing automation, and solving most complicated challenges.",
      image: "/images/New/Custom AI Implementation.png",
      benefits: [
    ...
    },
    {
      ...
      image: "/images/New/AI Strategy Development.png",
      benefits: [
