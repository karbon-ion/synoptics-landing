                ...
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="space-y-8">
                        ...
                        <p className="text-gray-700">
                            Basic automation isn’t built for complex operations. Synoptix AI goes further—breaking down intricate tasks, distributing work intelligently, and executing every step with
                            precision—eliminating delays and inefficiencies.
                        </p>

                        <p className="text-gray-700">
                            In real time, specialized agents analyze data, structure insights, and refine outputs, ensuring accuracy at every stage. Whether managing multi-step operations or high-stakes decisions, Synoptix adapts dynamically to keep everything on track
                        </p>

                        <p className="text-gray-700">
                            This isn’t just automation—it’s intelligent workflow at its best. Tasks move forward seamlessly, approvals happen without hold-ups, and systems stay perfectly in sync. No bottlenecks. No micromanaging. Just faster execution and smarter decision-making.
                        </p>
