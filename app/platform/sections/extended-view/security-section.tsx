  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
      ...
      <div className="col-span-1 md:col-span-6 bg-white rounded-lg shadow-sm mb-3 md:mb-0">
        <div className="bg-[#F1F5FC] rounded-lg py-2 mb-6">
          <p className="text-black font-medium text-center" style={{ fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '18px' }}>Integration</p>
        </div>
        <div className="grid grid-cols-3 p-6 gap-6 w-full">
          <div className="bg-gray-50 rounded-lg p-6 flex flex-col">
            <p className="text-center mb-8" style={{ fontFamily: 'Syne', fontWeight: '700', fontSize: '16px' }}>Structured</p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 flex flex-col">
            <p className="text-center mb-8" style={{ fontFamily: 'Syne', fontWeight: '700', fontSize: '16px' }}>Unstructured</p>
            <div className="flex gap-3 items-center justify-center mt-auto">
          ...
          <div className="bg-gray-50 rounded-lg p-6 flex flex-col">
            <p className="text-center mb-8" style={{ fontFamily: 'Syne', fontWeight: '700', fontSize: '14px' }}>Foundational Models</p>
            <div className="flex gap-3 items-center justify-center mt-auto">
      ...
      <div className="col-span-1 md:col-span-3 bg-white rounded-lg shadow-sm mb-3 md:mb-0">
        <div className="bg-[#F1F5FC] rounded-lg py-2 mb-6">
          <p className="text-black font-medium text-center" style={{ fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '18px' }}>Business Application<br />and Tools</p>
        </div>
        <div className="bg-gray-50 rounded-lg p-6 flex flex-col">
      ...
      <div className="col-span-1 md:col-span-3 bg-white rounded-lg shadow-sm">
        <div className="bg-[#F1F5FC] rounded-lg py-2 mb-6">
          <p className="text-black font-medium text-center" style={{ fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '18px' }}>Deployment</p>
        </div>
        <div className="bg-gray-50 rounded-lg p-6 pt-12 flex flex-col">
