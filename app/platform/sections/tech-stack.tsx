    ...
    <div className="bg-[#5662F6] w-[92%] md:w-full max-w-6xl mx-auto rounded-xl md:rounded-2xl mb-6 md:mb-10 p-4 md:p-10 flex flex-col md:flex-row items-center relative overflow-hidden text-white">
      <div className="w-[90%] md:w-full md:max-w-md mb-4 md:mb-0 p-3 md:p-10 z-10">
        <h2 className="font-semibold leading-tight md:leading-snug">
          ...
          <span className="block" style={{ fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "24px", lineHeight: "normal", letterSpacing: "0%", whiteSpace: "nowrap" }}>Designed to Secure Your Enterprise’s Data </span>
        </h2>
        ...
        Our platform acts as a central intelligence hub, securely connecting your tools, workflows, and teams. It protects your company data, supports compliance, and keeps your business running without disruption. 
        </p>
