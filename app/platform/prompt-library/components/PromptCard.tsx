...
export function PromptCard({ title, description, tags, icons, onRun }: PromptCardProps) {
  return (
    <div className="group p-6 bg-white border border-gray-200 rounded-[20px] hover:border-gray-300 hover:shadow-lg transition-all cursor-pointer w-[350px] h-[214px]">
          ...
          <div className="flex flex-col gap-3 items-start">
            ...
            <button 
              onClick={(e) => {
                ...
                const drawerElement = document.querySelector('.prompt-library-drawer');
                if (drawerElement) {
