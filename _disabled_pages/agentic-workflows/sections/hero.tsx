...
export default function RagHero() {
    return (
        <section className="min-h-screen flex flex-col items-center justify-center text-center px-4 py-16 bg-gradient-to-b bg-[#f0f5ff]">
            ...
            Discard manual slowdowns—let AI take control. Synoptix AI routes tasks, consolidates insights, and refines outputs with precision through intelligent Agentic Workflows.</p>
